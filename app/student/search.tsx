...
import {
  ...
  TextInput, Modal, Image, Linking, Platform, Alert,
} from 'react-native';
        ...
        <SafeAreaView edges={['top']} style={s.headerInner}>
          ...
          <View style={s.controlRow}>
            ...
            <TouchableOpacity
              ...
              onPress={openFilters}
            >
              <SlidersHorizontal size={16} color={activeCount > 0 ? Colors.white : Colors.primary[100]} />
          ...
          <View style={s.modalPanel}>
            ...
            <View style={s.modalActions}>
              ...
              <TouchableOpacity style={s.applyBtn} onPress={applyModal}>
                <Text style={s.applyBtnTxt}>Aplicar filtros{activeCount > 0 ? ` (${activeCount})` : ''}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
    ...
    >
      ...
      <View style={s.cardBody}>
        ...
        <View style={s.cardMeta}>
          ...
          {t.cref ? <View style={s.crefTag}><Text style={s.crefText}>CREF {t.cref}</Text></View> : null}
        </View>
...
const s = StyleSheet.create({
  ...
  crefTag: { backgroundColor: Colors.primary[50], paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999 },
  crefText: { fontSize: 10, fontWeight: '600', color: Colors.primary[700] },
